<?php
	define('CONF_SHOP_NAME', 'Shop-Script Free Lego Edition SP');
	define('CONF_SHOP_DESCRIPTION', 'Shop-Script Free, powered by Shop-Script, Lego Edition SP');
	define('CONF_SHOP_KEYWORDS', 'Shop-Script Free, powered by Shop-Script Lego Edition SP');
	define('CONF_SHOP_URL', 'lego');
